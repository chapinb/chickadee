...
class WritersTestCase(unittest.TestCase):
    ...
    def setUp(self):
        """Configure test data"""
        self.data = [OrderedDict(**{"a": "1", "b": "2", "regionName": "Île-de-France"})]
    ...
    def test_write_csv(self):
        ...
        self.assertDictEqual(self.data[0], read_data)

    def test_write_json(self):
        """Test writing information to a JSON file"""
        data = [{"a": "1", "b": "2", "regionName": "Île-de-France"}]
    ...
    def test_write_json_headers(self):
        ...
        rec.pop("regionName")
        rec["none"] = None
        self.assertDictEqual(rec, read_data[0])
